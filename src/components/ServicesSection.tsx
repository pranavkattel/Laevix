                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-0">
                        {services.map((service, index) => (
                            <motion.div
                                ...
                                viewport={{ once: true }}
                                className={`flex flex-col p-6 md:p-12 ${index !== 2 ? 'md:border-r border-white/5' : ''}`}
                            >
                                <div className="aspect-square w-full mb-8 md:mb-12 bg-gradient-to-br from-neutral-800 to-neutral-900 rounded-sm flex items-center justify-center relative overflow-hidden group shadow-[0_0_30px_rgba(239,68,68,0.3)] hover:shadow-[0_0_60px_rgba(239,68,68,0.6)] transition-all duration-500">
