...
export function Header() {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 bg-neutral-200/95 dark:bg-black/80 backdrop-blur-md border-b border-neutral-900 dark:border-transparent transition-colors duration-300" role="banner">
      <nav className="flex items-center justify-between px-4 md:px-12 lg:px-24 h-16 md:h-20" role="navigation" aria-label="Main Navigation">
        {/* Logo */}
        <Link to="/" className="group flex items-center gap-2 z-50" aria-label="Laevix - Home">
          <img src={laevixLogo} alt="Laevix - AI Tech Company Nepal" className="w-10 h-10 md:w-12 md:h-12 transition-all duration-300" />
        </Link>
