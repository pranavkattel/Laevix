      ...
      <section className="relative min-h-screen flex items-center justify-center bg-black overflow-hidden pt-24">
        ...
        <div className="absolute inset-0 flex items-center justify-center pointer-events-none select-none">
          <motion.h1 
            ...
            className="text-[20vw] font-black uppercase tracking-tighter leading-none text-neutral-800/50"
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-6 text-center">
          ...
          >
            ...
            <h2 className="text-4xl md:text-6xl font-normal text-neutral-300 leading-relaxed mb-12">
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-1 gap-0">
            {services.map((service, index) => (
              <motion.div
                ...
                className="group border-t border-white/10 py-16 md:py-24 relative"
              >
                {/* Background Glow */}
                ...
                <div className="grid grid-cols-1 md:grid-cols-12 gap-12 relative z-10">
                  ...
                  <div className="md:col-span-3 flex flex-col items-start">
                    <span className="text-6xl font-black text-neutral-800 group-hover:text-red-600/40 transition-colors duration-500 mb-8">
                      {service.number}
                    </span>
                    <motion.div
                      animate={{
                      ...
                      className="w-32 h-32 bg-neutral-900 border border-white/10 group-hover:border-red-600/50 flex items-center justify-center group-hover:bg-red-600/10 transition-all duration-500"
                    >
                      <span className="text-6xl text-white/20 group-hover:text-red-600 transition-colors duration-500">
                        {service.icon}
                      </span>
                    </motion.div>
                  </div>
                  ...
                  <div className="md:col-span-6">
                    <h3 className="text-7xl md:text-9xl font-black uppercase tracking-tighter mb-8 text-white group-hover:text-red-600 transition-colors duration-500">
                      {service.fullTitle}
                    </h3>
                  ...
                  <div className="md:col-span-3">
                    <h4 className="text-sm font-bold uppercase tracking-widest text-neutral-500 mb-6">Includes:</h4>
                    <ul className="space-y-3">
                      {service.includes.map((item, i) => (
                        <motion.li
                          ...
                          className="text-sm font-medium text-neutral-600 group-hover:text-neutral-400 transition-colors duration-300 border border-neutral-800 group-hover:border-red-600/30 px-4 py-2 uppercase tracking-wider"
                        >
                          {item}
                        </motion.li>
                      ))}
          ...
          >
            <button
              ...
              className="group inline-flex items-center gap-4 px-12 py-6 bg-red-600 text-white font-bold text-lg uppercase tracking-widest hover:bg-white hover:text-black transition-all duration-300"
            >
              Start Your Project
