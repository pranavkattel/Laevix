...
export default function Work() {
  ...
  return (
    <div className="min-h-screen bg-neutral-200 dark:bg-black transition-colors duration-300">
      ...
      <section className="relative min-h-screen flex items-center justify-center bg-neutral-300 dark:bg-black overflow-hidden pt-24 transition-colors duration-300">
        ...
        <div className="absolute inset-0 flex items-center justify-center pointer-events-none select-none">
          <motion.h1 
            ...
            className="text-[25vw] font-black uppercase tracking-tighter leading-none text-neutral-800/80 dark:text-neutral-800/50"
          ...
          >
            <div className="flex flex-col md:flex-row md:items-end md:justify-between mb-12">
              <div>
                ...
                <h2 className="text-6xl md:text-8xl font-black uppercase tracking-tighter text-neutral-900 dark:text-white">
                  SELECTED<br />
                  <span className="text-red-600">WORK</span>
                  <sup className="text-2xl align-super">®</sup>
                </h2>
              </div>
              <p className="text-neutral-700 dark:text-neutral-400 text-lg max-w-md mt-8 md:mt-0">
      ...
      {/* Projects Grid */}
      <section ref={ref} className="relative bg-neutral-200 dark:bg-black py-20 transition-colors duration-300">
          ...
          <div className="grid grid-cols-1 gap-0">
            {projects.map((project, index) => (
              <motion.a
                ...
                className="group border-t border-neutral-300 dark:border-white/5 py-16 md:py-20 hover:border-red-600/30 transition-all duration-500 relative"
              >
                {/* Hover Background */}
                ...
                <div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-center relative z-10">
                  ...
                  <div className="md:col-span-7">
                    <div className="mb-4">
                      <span className="inline-block bg-red-600 text-neutral-100 text-xs font-bold uppercase tracking-widest px-4 py-1.5 mb-4">
                        {project.category}
                      </span>
                    </div>
                    <h3 className="text-5xl md:text-7xl font-black uppercase tracking-tighter mb-6 text-neutral-900 dark:text-white group-hover:text-red-600 transition-colors duration-300">
                      {project.name}
                    </h3>
                    <p className="text-lg text-neutral-700 dark:text-neutral-400 leading-relaxed max-w-2xl group-hover:text-neutral-800 dark:group-hover:text-neutral-300 transition-colors duration-300">
                      {project.description}
                    </p>
                    <div className="flex gap-3 mt-6">
                      {project.tags.map((tag, i) => (
                        <span key={i} className="text-xs font-bold uppercase tracking-widest text-neutral-700 dark:text-neutral-600 border border-neutral-400 dark:border-neutral-800 group-hover:border-red-600/30 group-hover:text-red-600 px-4 py-2 transition-all duration-300">
                          {tag}
                        </span>
                      ))}
                    </div>
                  ...
                  <div className="md:col-span-4 flex items-center justify-between md:justify-end gap-8">
                    <span className="text-2xl font-bold text-neutral-600 dark:text-neutral-700 group-hover:text-neutral-800 dark:group-hover:text-neutral-500 transition-colors duration-300">
                      {project.year}
                    </span>
                    <div className="w-16 h-16 border-2 border-neutral-400 dark:border-white/10 group-hover:border-red-600 flex items-center justify-center group-hover:bg-red-600 transition-all duration-500 group-hover:rotate-45">
                      <ArrowUpRight className="w-8 h-8 text-neutral-900 dark:text-white group-hover:-rotate-45 transition-transform duration-500" />
                    </div>
                  </div>
                </div>
              </motion.a>
